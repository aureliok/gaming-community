...
export function checkPassword(passwordInput, strongPassword) {
...
export function checkIfPasswordEqual(passwordInput, confirmPasswordInput, passwordEquality) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function checkCurrentPassword(passwordInput, correctPassword) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("/CheckCurrentPassword", {
                        method: "POST",
                        headers: {
...
export function checkEmailInput(emailInput, emailAvailability) {
    return __awaiter(this, void 0, void 0, function () {
        var email, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
